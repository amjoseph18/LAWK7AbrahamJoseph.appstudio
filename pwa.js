...
const cacheName = 'LAWK7AbrahamJoseph-2021-03-22 21:50:41.822222'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWK7AbrahamJoseph'.length) === 'LAWK7AbrahamJoseph') {
